// Pingo — Rule-based detection engine.
// Shared by the CLI wrapper and the VS Code extension so both use one engine.
...
// Default rules. These mirror the rules the desktop app used to seed, so
// detection works fully offline / standalone in both the CLI and the extension.
